  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php echo active_link('Guest'); ?> treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="<?php echo active_link('Guest'); ?>"><a href="<?php echo site_url('Guest') ?>"><i class="fa fa-circle-o"></i> Data Pengunjung</a></li>
