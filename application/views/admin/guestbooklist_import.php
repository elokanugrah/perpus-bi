<?php $this->load->view('headerfooter/header_admin'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('GuestBookList') ?>"><i class="fa fa-table"></i> Buku Tamu</a></li>
        <li class="<?php echo active_link('GuestBookList') ?>"><a href="#">Import</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?php echo site_url('excel/format_guestbook.xlsx') ?>" class="btn btn-success btn-sm badge mt-1 pull-right"><span class="fa fa-file-excel-o" style="padding-right: 4px;"></span> Download Format</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form method="post" action="<?php echo site_url('GuestBookList/form'); ?>" enctype="multipart/form-data">
                <!-- 
                  ...
                  <div class="col-md-12 form-group">
                    <div class="input-group">
                      ...
                      <div class="input-group-addon">
                        ...
                        <a href="<?php echo site_url('GuestBookList/import_data') ?>" class="btn btn-default btn-sm badge mt-1">Reset</a>
                      </div>
                    </div>
              ...
              <?php
                ...
                if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
                  ...
                  echo "<form method='post' action='".site_url('GuestBookList/import')."'>";
                  ...
                  foreach($sheet as $row){ 
                    ...
                    $date = $row['C']; // Ambil data jenis kelamin
                    $time = $row['D']; // Ambil data jenis kelamin
                    ...
                    if(empty($member_id) && empty($id_number) && empty($name) && empty($date) && empty($time))
                    ...
                    if($numrow > 1){
                      ...
                      $time_td = ( ! empty($time))? "" : " class='bg-red-active color-palette'"; // Jika Alamat kosong, beri warna merah
                      
                      // Jika salah satu data ada yang kosong
                      if(empty($id_number) or empty($name) or empty($date) or empty($time)){
                      ...
                      echo "<td".$time_td.">".date('H:i',strtotime($time))."</td>";
                      echo "</tr>";
                    }
